...
entry:
  ...
  %call.add = call ptr @add(ptr %rcc.val.heap, ptr %rcc.val.heap1)
...
sout.merge:                                       ; preds = %sout.default, %sout.null, %sout.str, %sout.bool.merge, %sout.float, %sout.int
  ...
  %rcc.val.heap9 = call ptr @malloc(i64 16)
  %tag.ptr10 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap9, i32 0, i32 0
  store i64 1, ptr %tag.ptr10, align 4
  %payload.ptr11 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap9, i32 0, i32 1
  store ptr inttoptr (i64 5 to ptr), ptr %payload.ptr11, align 8
  %call.factorial = call ptr @factorial(ptr %rcc.val.heap9)
...
cond.merge:                                       ; preds = %cond.next.0
  ...
  %rcc.val.heap27 = call ptr @malloc(i64 16)
  %tag.ptr28 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap27, i32 0, i32 0
  store i64 1, ptr %tag.ptr28, align 4
  %payload.ptr29 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap27, i32 0, i32 1
  ...
  %tag.ptr32 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap27, i32 0, i32 0
...
arith.float37:                                    ; preds = %cond.merge
  ...
  %payload.ptr43 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap27, i32 0, i32 1
  ...
  store ptr %rcc.val.heap55, ptr %arith.result40, align 8
...
arith.int38:                                      ; preds = %cond.merge
  ...
  %payload.ptr60 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap27, i32 0, i32 1
  ...
  store ptr %rcc.val.heap65, ptr %arith.result40, align 8
  br label %arith.merge39
...
arith.float76:                                    ; preds = %arith.merge39
  ...
  %rcc.val.heap94 = call ptr @malloc(i64 16)
  %tag.ptr95 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap94, i32 0, i32 0
  store i64 2, ptr %tag.ptr95, align 4
  %payload.ptr96 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap94, i32 0, i32 1
  store ptr %result.float.ptr93, ptr %payload.ptr96, align 8
  store ptr %rcc.val.heap94, ptr %arith.result79, align 8
...
arith.int77:                                      ; preds = %arith.merge39
  ...
  %rcc.val.heap104 = call ptr @malloc(i64 16)
  %tag.ptr105 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap104, i32 0, i32 0
  store i64 1, ptr %tag.ptr105, align 4
  %payload.ptr106 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap104, i32 0, i32 1
  store ptr %int.ptr103, ptr %payload.ptr106, align 8
  store ptr %rcc.val.heap104, ptr %arith.result79, align 8
  br label %arith.merge78
