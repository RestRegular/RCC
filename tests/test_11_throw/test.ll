...
entry:
  ...
  %payload.ptr4 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val, i32 0, i32 1
  %payload5 = load ptr, ptr %payload.ptr4, align 8
  %left.int = ptrtoint ptr %payload to i64
  %right.int = ptrtoint ptr %payload5 to i64
  ...
  %tag = load i64, ptr %tag.ptr9, align 4
  %payload.ptr10 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val6, i32 0, i32 1
  %payload11 = load ptr, ptr %payload.ptr10, align 8
  %is_null = icmp eq i64 %tag, 0
  %is_int = icmp eq i64 %tag, 1
  %is_bool = icmp eq i64 %tag, 3
  %is_bool_or_int = or i1 %is_bool, %is_int
  %payload.int = ptrtoint ptr %payload11 to i64
...
cond.merge:                                       ; preds = %cond.next.0, %throw.unreachable
  ...
  %b.load15 = load ptr, ptr %b2, align 8
  %payload.ptr16 = getelementptr inbounds nuw %RCCValue, ptr %a.load, i32 0, i32 1
  %payload17 = load ptr, ptr %payload.ptr16, align 8
  %payload.ptr18 = getelementptr inbounds nuw %RCCValue, ptr %b.load15, i32 0, i32 1
  ...
  %div = sdiv i64 %left.int20, %right.int21
  %int.ptr22 = inttoptr i64 %div to ptr
