...
entry:
  ...
  store ptr %rcc.val.heap, ptr %x, align 8
  ...
  store ptr %rcc.val.heap1, ptr %y, align 8
...
sout.merge:                                       ; preds = %sout.default, %sout.null, %sout.str, %sout.bool.merge, %sout.float, %sout.int
  ...
  store ptr %rcc.val.heap27, ptr %name, align 8
...
sout.merge40:                                     ; preds = %sout.default39, %sout.null38, %sout.str37, %sout.bool.merge48, %sout.float35, %sout.int34
  ...
  %rcc.val.heap49 = call ptr @malloc(i64 16)
  %tag.ptr50 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap49, i32 0, i32 0
  store i64 0, ptr %tag.ptr50, align 4
  %payload.ptr51 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap49, i32 0, i32 1
  ...
  store ptr %rcc.val.heap52, ptr %flag, align 8
...
sout.merge65:                                     ; preds = %sout.default64, %sout.null63, %sout.str62, %sout.bool.merge73, %sout.float60, %sout.int59
  ...
  %rcc.val.heap74 = call ptr @malloc(i64 16)
  %tag.ptr75 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap74, i32 0, i32 0
  store i64 0, ptr %tag.ptr75, align 4
  %payload.ptr76 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val.heap74, i32 0, i32 1
