...
sout.int13:                                       ; preds = %sout.merge
  %10 = call i32 (ptr, ...) @printf(ptr @.str.10, ptr %payload12)
...
sout.float14:                                     ; preds = %sout.merge
  ...
  %11 = call i32 (ptr, ...) @printf(ptr @.str.11, double %float.val21)
  br label %sout.merge19
...
sout.int37:                                       ; preds = %sout.merge19
  %18 = call i32 (ptr, ...) @printf(ptr @.str.20, ptr %payload36)
...
sout.float38:                                     ; preds = %sout.merge19
  ...
  %19 = call i32 (ptr, ...) @printf(ptr @.str.21, double %float.val45)
  br label %sout.merge43
...
sout.str40:                                       ; preds = %sout.merge19
  %20 = call i32 (ptr, ...) @printf(ptr @.str.26, ptr %payload36)
  br label %sout.merge43
...
sout.default42:                                   ; preds = %sout.merge19
  %22 = call i32 (ptr, ...) @printf(ptr @.str.29, ptr %payload36)
  br label %sout.merge43
...
sout.int61:                                       ; preds = %sout.merge43
  %26 = call i32 (ptr, ...) @printf(ptr @.str.30, ptr %payload60)
...
sout.float62:                                     ; preds = %sout.merge43
  ...
  %27 = call i32 (ptr, ...) @printf(ptr @.str.31, double %float.val69)
  br label %sout.merge67
...
sout.str64:                                       ; preds = %sout.merge43
  %28 = call i32 (ptr, ...) @printf(ptr @.str.36, ptr %payload60)
  br label %sout.merge67
...
sout.default66:                                   ; preds = %sout.merge43
  %30 = call i32 (ptr, ...) @printf(ptr @.str.39, ptr %payload60)
  br label %sout.merge67
...
sout.merge67:                                     ; preds = %sout.default66, %sout.null65, %sout.str64, %sout.bool.merge74, %sout.float62, %sout.int61
  ...
  store i64 4, ptr %tag.ptr79, align 4
  %payload.ptr80 = getelementptr inbounds nuw %RCCValue, ptr %rcc.val78, i32 0, i32 1
  store ptr @.str.40, ptr %payload.ptr80, align 8
