...
|       **`v1.18.0`**       | 2025-11-23 |                           实现错误处理机制                           |                **[Feature]**                 | RestRegular |
|       **`v1.19.0`**       | 2025-11-24 |                            完善标签系统                            |                **[Feature]**                 | RestRegular |
| **`v1.20.0`** | 2025-11-24 | 调整了标签描述比较逻辑，新增匿名函数简写形式 | **[Optimize] [Feature]** | RestRegular |
| **`v1.21.0`** | 2025-11-28 | 适配Linux平台并修复部分符号错误 | **[Feature] [BugFix]** | RestRegular |
...
---
### 版本号 `v1.21.0` (2025-11-28)
- **类型**：**[Feature] [BugFix]**
- **作者**：RestRegular
- **更新时间**：2025/11/28 16:02
- **更新内容**：
  - 新增适配Linux平台功能。
  - 修复了部分符号静态初始化的错误。

---
### 版本号 `v1.20.0` (2025-11-24)
- **类型**：**[Optimize] [Feature]**
- **作者**：RestRegular
- **更新时间**：2025/11/24 14:44
- **更新内容**：
  - 调整了标签描述相等比较逻辑。
  - 新增匿名函数语法简写形式，当函数体只有一条语句且为返回语句时可省略 `{}` 和 `ret`。
  - **注意**：当使用简写形式的匿名函数作为参数，并且该参数不位于多参列表末尾时，函数体内的语句应使用 `;` 分隔符进行分隔，以明确其与后续参数的并列关系。

---
### 版本号 `v1.19.0` (2025-11-24)
- **类型**：**[Feature]**
- **作者**：RestRegular
- **更新时间**：2025/11/24 09:38
- **更新内容**：
  - 完善标签系统，目前支持使用形如 `ds.List` 这种包含属性访问符的标签。

---
### 版本号 `v1.18.0` (2025-11-23)
- **类型**：**[Feature]**
- **作者**：RestRegular
- **更新时间**：2025/11/23 15:45
- **更新内容**：
  - 实现了 `try { ... } catch (...) { ... } finally { ... }` 错误处理机制。
