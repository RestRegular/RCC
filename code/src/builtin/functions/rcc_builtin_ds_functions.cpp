...
namespace builtin
{
    ...
    BuiltinFuncRetType rcc_copy(ast::CompileVisitor& visitor, const CallInfos& callInfos)
    {
        ...
        const auto &[typeLabel, valueType] = visitor.getTypesFromOpItem(callInfos.posArgsOpItems.front());
        visitor.pushTemOpVarItemWithRecord(utils::Pos::UNKNOW_POS, valueType, nullptr, true, typeLabel);
    ...
    {
        if (const auto &[typeLabel, valueType] = visitor.getTypesFromOpItem(callInfos.posArgsOpItems.front());
        ...
        const auto &firstSymbol = visitor.getSymbolFromOpItem(callInfos.posArgsOpItems.front());
        ...
        throw base::RCCCompilerError::typeMissmatchError(errorPos.toString(), visitor.getCodeLine(errorPos),
            ...
            callInfos.posArgsOpItems.front().getValueType()->toString(), {});
    }
    ...
    {
        visitor.pushTemOpVarItemWithRecord(utils::Pos::UNKNOW_POS, symbol::TypeLabelSymbol::listTypeSymbol(utils::Pos::UNKNOW_POS, visitor.getSymbolTable().curScopeLevel()));
