...
namespace parser {
    ...
    static std::unordered_map<core::TokenType, NodeType> infixExpressionNodeTypeMap = {
        ...
        {TokenType::TOKEN_PLUS_ASSIGN, NodeType::INFIX},
        {TokenType::TOKEN_MINUS_ASSIGN, NodeType::INFIX},
        {TokenType::TOKEN_STAR_ASSIGN, NodeType::INFIX},
        {TokenType::TOKEN_SLASH_ASSIGN, NodeType::INFIX},
        {TokenType::TOKEN_MODULO_ASSIGN, NodeType::INFIX},
